...
func (a *API) PhoneOneClickToken(w http.ResponseWriter, r *http.Request) error {
	ctx := r.Context()
	grantType := r.FormValue("grant_type")

	switch grantType {
	case "refresh_token":
		return a.PhoneOneClickRefreshTokenGrant(ctx, w, r)
	default:
		return oauthError("unsupported_grant_type", "")
	}
}

// PhoneOneClickRefreshTokenGrant implements the refresh_token grant type flow
func (a *API) PhoneOneClickRefreshTokenGrant(ctx context.Context, w http.ResponseWriter, r *http.Request) error {
